...
public abstract class TestCore {
	...
	private static String xml = "default";

	public TestCore(String xmlname) {
		xml = xmlname;
	}
	...
	public static Archive<?> createDeployment() {
		...
		return ShrinkWrap.create(WebArchive.class, "orderQuery.war").addPackages(true, "mh.dev.common.orderquery").addAsLibraries(libraries)
				.addAsResource("META-INF/persistence.xml", "META-INF/persistence.xml").addAsResource("orderquery/" + xml + ".xml", "META-INF/orderquery.xml")
